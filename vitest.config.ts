...
export default defineConfig({
  ...
  test: {
    ...
    restoreMocks: true,
    clearMocks: true,
    // Hosted Windows runners can need more than Vitest's five-second default for
    // filesystem and ACL-heavy tests; keep a finite cap while preserving the
    // faster hang signal on other platforms.
