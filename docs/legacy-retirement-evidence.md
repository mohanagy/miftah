...
| Recorder | `tests/fixtures/named-host-stdio-recorder.mjs`, SHA-256 `3764fce9814a44475f49fa81f904c553a6947b6e85b6692f5798c8e3759a5994`; persists only client/server version, protocol, operation name/count/status, initialized notification, and process exit state |
